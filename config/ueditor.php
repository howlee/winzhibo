...
return [
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/articles/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'scrawlPathFormat' => '/articles/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'snapscreenPathFormat' => '/articles/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/articles/images/{yyyy}{mm}{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
